  ...
  return (
    <div className="container min-h-screen">
      ...
      <div>
                    ...
                    <>
                      {
                        ...
                        <div className="mb-20 mt-6 text-center">
                          <button onClick={() => { setKioskId(kioskIds[0]) }}>View Kiosk</button>
                        </div>
                      }

                      {currentAccount &&
                        <div className="flex gap-4 mt-6 justify-center">
                          {kioskIds.length < 1 && <button onClick={createNewKiosk}>Create New Kiosk</button>}
                        </div>
        ...
        {kioskId && <KioskData kioskOwnerCap={kioskOwnerCaps[0]} kioskId={kioskId} setSelectedKiosk={setKioskId} />}
