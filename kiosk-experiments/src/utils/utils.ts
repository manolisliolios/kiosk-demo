...
import { SuiObjectResponse, getObjectDisplay, getObjectId, getObjectType } from "@mysten/sui.js";
...
export const parseObjectDisplays = (data: SuiObjectResponse[]): OwnedObjectType[] => {
    return data.map((x) => {
        return (
            {
                id: getObjectId(x),
